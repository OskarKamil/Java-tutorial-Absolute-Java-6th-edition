...
public class Sub2 extends JFrame {
    ...
    public Sub2() {
        ...
        label1.setIcon(new ImageIcon("src/resources/wolf.png"));
        /*
        ...
        label2.setIcon(new ImageIcon("src/resources/wolf2.png"));
        /* The file we need, sometimes may be outside the current folder. For example if file wolf2.png was outside our current working folder, the path for this file would look like this ../wolf2.png. ../ in file path means 'exit current folder'. */
